...
public class addIndividualLock extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_individual_lock);
...
// reg_btn.setVisibility(View.GONE);
                    ...
                    Intent i=new Intent(addIndividualLock.this,MainActivity.class);
                    startActivity(i);
                }
            }
        });
        ...
        cancel.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
// TODO Auto-generated method stub
                Intent ii=new Intent(addIndividualLock.this,MainActivity.class);
                startActivity(ii);
            }
        });
    }
